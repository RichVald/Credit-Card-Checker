...
// Test function
console.log(findInvalidCards([valid1, valid2, valid3]));// Shouldn't print anything
console.log(findInvalidCards([invalid1, invalid2, invalid3])); // Should print all of the numbers

console.log(findInvalidCards(batch)); // Test what the mystery numbers are

//should return an array of companies that have mailed out cards with invalid numbers.
